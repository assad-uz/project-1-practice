<?php
require_once("includes/aheader.php")
?>
<!-- Layout wrapper -->
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        <!-- Menu -->
      <?php 
      require_once ("includes/asidebar.php")
      ?>
        ...
        <?php 
        require_once("includes/anavbar.php")
        ?>
  ...
  <h5 class="mb-0 fw-semibold">Today's Booking</h5>
</div>
...
<div class="text-center">
  ...
  <h5 class="mb-0 fw-semibold">Profit</h5>
</div>

<div class="text-center">
  <h4 class="mb-0 fw-bold">$1,100</h4>
</div>
  ...
  <h5 class="mb-0 fw-semibold">Sales</h5>
</div>

<div class="text-center">
  <h4 class="mb-0 fw-bold">$3,500</h4>
</div>
      </div>
    </div>
  </div>
...
<div class="text-center">
  <h4 class="mb-0 fw-bold">$5,200</h4>
</div>
...
<!-- ekhane shes end -->
            ...
            <!-- Footer -->
<?php 
require_once("includes/afooter.php")
?>